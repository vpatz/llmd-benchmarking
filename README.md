...
| [`1.2`](1.2/README.md) | Default Kubernetes routing (baseline) | AMD GPU | 2 vLLM instances, 4 GPUs each |
| [`2.1`](2.1/README.md) | Prefix-based routing (same GPU type) | NVIDIA GPU | 2 vLLM instances, tensor parallelism 2 |
| [`2.2`](2.2/README.md) | Prefix-based routing (same GPU type) | AMD GPU | 2 vLLM instances, 4 GPUs each |
